                    ...
                    t.exports = function (d, e, f) {
                        ...
                        return (
                            (f.proxy =
                                f.proxy ||
                                function (e) {
                                    return fetch("https://api.bloggify.net/gh-calendar/?username=" + e).then(function (
                                        e
                                    ) {
                                        return e.text();
                                    });
                                    ...
                                    .then(function (e) {
                                        ...
                                        try {
                                            for (
                                                ...
                                                var c = s.value;
                                                c.textContent.includes("View your contributions in 3D, VR and IRL!") &&
                                        ...
                                        e.querySelector("include-fragment")
                                            ? setTimeout(l, 500)
                                            : (!0 === f.responsive &&
                                                  ((a = (n = e.querySelector("svg.js-calendar-graph-svg")).getAttribute(
                                                      "width"
                                                  )),
                                              ...
                                              !1 !== f.global_stats &&
                                                  ((a = (n = p(g("svg", e).outerHTML)).current_streak
                                                      ...
                                                      : n.last_contributed
                                                      ? "Last contributed in " + m(n.last_contributed, y) + "."
                                                      : "Rock - Hard Place"),
                                                  (u = n.longest_streak
                                                  ...
                                                  (t = g("<div>", {
                                                      ...
                                                      html:
                                                          ...
                                                          m(b.add(b.subtract(new Date(), 1, "year"), 1, "day"), h) +
                                                          " &ndash; " +
                                                          m(new Date(), h) +
                                                          "</span>",
                                                  })),
                                                          ...
                                                          e.addEventListener("mouseenter", function (e) {
                                                              var t = e.target.getAttribute("data-count"),
                                                                  ...
                                                                  e =
                                                                      ...
                                                                      r.offsetHeight -
                                                                      2 * t.height;
                                                              (r.style.top = e + "px"), (r.style.left = n + "px");
                                                          }),
                    ...
                    t.exports = function (e) {
                        ...
                        return (
                            e
                                ...
                                .forEach(function (e) {
                                    if (e.startsWith("<g transform")) return a.length && o.weeks.push(a) && (a = []);
                                    var t = e.match(/data-level="([0-9\-]+)"/i),
                                        ...
                                        e = e && +e[1];
                                    t &&
                                        ((n = {fill: u[t], date: new Date(n), count: e, level: t}),
            ...
            11: [
                function (e, t, n) {
                            ...
                            (r(s, [
                                {
                                    ...
                                    value: function value(e, t) {
                                        ...
                                        do {
                                            ...
                                            ((n += r
                                                ? (r = "function" == typeof (r = this.obj[r]) ? r.apply(this, t) : r)
                                                : o),
                    ...
                    function s(e) {
                        ...
                        (this.obj = e || {}), (this.re = new RegExp("^(" + Object.keys(e).map(a).join("|") + ")"));
                    }
                    function i(e, t, n) {
